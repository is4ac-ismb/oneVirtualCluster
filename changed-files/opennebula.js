...
var OpenNebula = {
    ...
    // Vcluster added by Antonio 
    "Vcluster" : {
        "resource" : "VCLUSTER",

        "create" : function(params){
            OpenNebula.Action.create(params,OpenNebula.Vcluster.resource);
        },
        "del" : function(params){
            OpenNebula.Action.del(params,OpenNebula.Vcluster.resource);
        },
        "list" : function(params){
            OpenNebula.Action.list(params,OpenNebula.Vcluster.resource);
        },
        "show": function(params){
            OpenNebula.Action.show(params,OpenNebula.Vcluster.resource);
        },
        "addvm" : function(params){
            var action_obj = { "vm_id": params.data.extra_param };
            OpenNebula.Action.simple_action(params,OpenNebula.Vcluster.resource,
                                            "addvm",action_obj);
        },
...
//            var action_obj = {"template_raw" : params.data.extra_param };
//            OpenNebula.Action.simple_action(params,
//                                            OpenNebula.Vcluster.resource,
//                                            "update",
//                                            action_obj);
//        }
    },
    // --- end of Antonio's adds
